...
public:
	...
	void menu_wl(workout_log& U1)
	{
		...
		do {
			...
			cout << "\n";
			cout << setw(38); cout << "1. Add new workout" << endl;
			cout << setw(40); cout << "2. View workout logs" << endl;
			cout << setw(41); cout << "3. Delete workout log" << endl;
			cout << setw(27); cout << "4. Exit" << endl;
			cout << "\n";
			cout << setw(39); cout << "Enter your choice: ";
			cin >> cho;
...
public:
	...
	void menu_fl(food_log& U1)
	{
		...
		do {
			...
			cout << "\n";
			cout << setw(42); cout << "1. Add new food log" << endl;
			cout << setw(40); cout << "2. View food logs" << endl;
			cout << setw(41); cout << "3. Delete food log" << endl;
			cout << setw(30); cout << "4. Exit" << endl;
			cout << "\n";
			cout << setw(42); cout << "Enter your choice: ";
			cin >> cho;
...
public:
	...
	void menu_pl(plan& U1)
	{
		...
		do {
			...
			cout << "\n";
			cout << setw(41); cout << "1. Add fitness plan" << endl;
			cout << setw(42); cout << "2. View fitness plan" << endl;
			cout << setw(44); cout << "3. Delete fitness plan" << endl;
			cout << setw(29); cout << "4. Exit" << endl;
			cout << "\n";
			cout << setw(41); cout << "Enter your choice: ";
			cin >> cho;
...
public:
	...
	void menu_lt(lifetime& U1)
	{
		...
		do {
			...
			cout << "\n";
			cout << setw(46); cout << "1. View life time record" << endl;
			cout << setw(29); cout << "2. Exit" << endl;
			cout << "\n";
			cout << setw(41); cout << "Enter your choice: ";
			cin >> cho;
...
public:
	...
	void menu_user(user& U1)
	{
		...
		do {
			...
			cout << "\n";
			cout << setw(41); cout << "1. Add user details" << endl;
			cout << setw(42); cout << "2. View user details" << endl;
			cout << setw(44); cout << "3. Delete user details" << endl;
			cout << setw(29); cout << "4. Exit" << endl;
			cout << "\n";
			cout << setw(41); cout << "Enter your choice: ";
			cin >> cho;
...
void menu_main()
{
	...
	cout.width(34);
	cout << "=========\n" << endl;
	cout << setw(35); cout << "1. Workout Logs" << endl;
	cout << setw(32); cout << "2. Food Logs" << endl;
	cout << setw(40); cout << "3. Life Time Records" << endl;
	cout << setw(35); cout << "4. Fitness Plan" << endl;
	cout << setw(35); cout << "5. User Details" << endl;
	cout << setw(38); cout << "6. Account Summary" << endl;
	cout << setw(36); cout << "7. Calculate BMI" << endl;
	cout << setw(27); cout << "8. Exit" << endl;
