...
public:
	...
	void wl_entry()
	{
		...
		cout << "\n" << endl;
		cout << setw(65); cout << "WORKOUT LOG ENTRY" << endl;
		for (i = 0; i < 120; i++)
		{
			cout << "_";
		}
...
public:
	...
	void fl_entry()
	{
		...
		cout << "\n" << endl;
		cout << setw(65); cout << "FOOD LOG ENTRY" << endl;
		for (i = 0; i < 120; i++)
		{
			cout << "_";
		}
...
void menu_wl(user& U1)
{
	...
	do {
		...
		cout << setw(69); cout << "2. Delete workout log" << endl;
		cout << setw(68); cout << "3. View workout logs" << endl;
		cout << setw(67); cout << "4. Edit workout log" << endl;
...
void menu_fl(user& U1)
{
	...
	do {
		...
		cout << "\n";
		cout << setw(69); cout << "1. Add new food log" << endl;
		cout << setw(68); cout << "2. Delete food log" << endl;
		cout << setw(67); cout << "3. View food logs" << endl;
		cout << setw(66); cout << "4. Edit food log" << endl;
...
void menu_user(user& U1)
{
	...
	do {
		system("cls");
		cout << "\n";
		cout << setw(73); cout << "U S E R   D E T A I L S   M E N U" << endl;
		cout << "\n";
		cout << setw(65); cout << "1. Add user details" << endl;
		cout << setw(66); cout << "2. View user details" << endl;
		cout << setw(66); cout << "3. Edit user details" << endl;
		cout << setw(68); cout << "4. Delete user details" << endl;
		cout << setw(53); cout << "5. Exit" << endl;
		cout << "\n";
		cout << setw(65); cout << "Enter your choice: ";
		cin >> cho;
